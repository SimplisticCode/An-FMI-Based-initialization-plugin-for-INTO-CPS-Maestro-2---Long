...
The set of interconnected variables in an algebraic loop is defined as a strongly connected component of the graph in \cref{def:initialization_graph}. \\
...
The initialization of the system requires application of fixed point iteration as defined by \cref{def:fixedpoint}.
