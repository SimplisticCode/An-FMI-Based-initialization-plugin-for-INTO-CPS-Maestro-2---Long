...
%In Defn. 2, it seems that L is a function U --> Y, does that mean that each input variable feeds-through only one output variable?
...
\end{definition}
%A faulty check will incur TODO
